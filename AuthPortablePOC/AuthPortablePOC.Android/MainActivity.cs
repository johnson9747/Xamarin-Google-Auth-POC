...
{
	[Activity(Label = "AuthPortablePOC", Icon = "@drawable/icon", Theme = "@style/MainTheme", MainLauncher = true, ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
	public class MainActivity : global::Xamarin.Forms.Platform.Android.FormsAppCompatActivity
	{
		...
		//{
		//	if (AuthChecks.CheckIfTokenExpiredAsync().Result)
		//		return;
		//	base.OnBackPressed();
		//}
	}
